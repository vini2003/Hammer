...
public class TiledFluidTexture implements BaseTexture {
	private final FluidVariant variant;
	
	private final Sprite sprite;
	private final Color color;
	
	public TiledFluidTexture(FluidVariant variant) {
	...
	public TiledFluidTexture(FluidVariant variant, Sprite sprite, Color color) {
		this.variant = variant;
