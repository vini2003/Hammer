...
class PartitionedTexture(
	...
	override fun draw(matrices: MatrixStack, provider: VertexConsumerProvider, x: Float, y: Float, width: Float, height: Float) {
		...
		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x, y, 0F, topLeftWidth, topLeftHeight, topLeft.uS, topLeft.vS, topLeft.uE, topLeft.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x + topLeftWidth, y, 0F, middleTopWidth, middleTopHeight, middleTop.uS, middleTop.vS, middleTop.uE, middleTop.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x + topLeftWidth + middleTopWidth, y, 0F, topRightWidth, topRightHeight, topRight.uS, topRight.vS, topRight.uE, topRight.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x, y + topRightHeight, 0F, middleLeftWidth, middleLeftHeight, middleLeft.uS, middleLeft.vS, middleLeft.uE, middleLeft.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x + middleLeftWidth + middleTopWidth, y + topRightHeight, 0F, middleRightWidth, middleRightHeight, middleRight .uS, middleRight.vS, middleRight.uE, middleRight.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x + topLeftWidth, y + topLeftHeight, 0F, centerWidth, centerHeight, center.uS, center.vS, center.uE, center.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x, y + centerHeight + topLeftHeight, 0F, bottomLeftWidth, bottomLeftHeight, bottomLeft.uS, bottomLeft.vS, bottomLeft.uE, bottomLeft.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x + topLeftWidth, y + centerHeight + topLeftHeight, 0F, middleBottomWidth, middleBottomHeight, middleBottom.uS, middleBottom.vS, middleBottom.uE, middleBottom.vE, 0x00F000F0, color, texture)

		DrawingUtils.drawTexturedQuad(matrices, provider, layer, x + topLeftWidth + middleBottomWidth, y + centerHeight + topLeftHeight, 0F, bottomRightWidth, bottomRightHeight, bottomRight.uS, bottomRight.vS, bottomRight.uE, bottomRight.vE, 0x00F000F0, color, texture)
	}
