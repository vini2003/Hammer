...
package dev.vini2003.`interface`.energy.common.widget.bar

import dev.vini2003.`interface`.energy.common.util.EnergyTextUtils
import dev.vini2003.hammer.H
import dev.vini2003.hammer.`interface`.common.widget.bar.BarWidget
...
open class EnergyBarWidget(
	...
	override fun getTooltip(): List<Text> {
		return if (current() == 0.0F) {
			...
			return EnergyTextUtils.tooltip(current(), maximum())
		}
	}
}