package dev.vini2003.hammer.`interface`.common.widget.list
...
open class ListWidget : Widget(), WidgetCollection {
    ...
    override fun drawWidget(matrices: MatrixStack, provider: VertexConsumerProvider, delta: Float) {
        ...
        val rawHeight = InstanceUtils.CLIENT.window.height.toFloat()
        val scale = InstanceUtils.CLIENT.window.scaleFactor.toFloat()
