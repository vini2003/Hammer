...
import dev.vini2003.hammer.serialization.api.common.function.Function10;
import dev.vini2003.hammer.serialization.api.common.node.Node;
import org.jetbrains.annotations.Nullable;

public class CompoundNode10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, N1 extends Node<T1>, N2 extends Node<T2>, N3 extends Node<T3>, N4 extends Node<T4>, N5 extends Node<T5>, N6 extends Node<T6>, N7 extends Node<T7>, N8 extends Node<T8>, N9 extends Node<T9>, N10 extends Node<T10>> extends Node<R> {
	...
	public CompoundNode10(N1 n1, N2 n2, N3 n3, N4 n4, N5 n5, N6 n6, N7 n7, N8 n8, N9 n9, N10 n10, Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> mapper) {
		this.n1 = n1;
		this.n2 = n2;
		this.n3 = n3;
		this.n4 = n4;
	...
	public <F, I> R deserialize(Deserializer<F> deserializer, @Nullable String key, F object, I instance) {
		...
		return set(mapper.apply(n1.deserialize(deserializer, key, map, instance), n2.deserialize(deserializer, key, map, instance), n3.deserialize(deserializer, key, map, instance), n4.deserialize(deserializer, key, map, instance), n5.deserialize(deserializer, key, map, instance), n6.deserialize(deserializer, key, map, instance), n7.deserialize(deserializer, key, map, instance), n8.deserialize(deserializer, key, map, instance), n9.deserialize(deserializer, key, map, instance), n10.deserialize(deserializer, key, map, instance)), instance);
	}
