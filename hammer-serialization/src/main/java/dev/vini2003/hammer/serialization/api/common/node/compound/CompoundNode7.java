...
import dev.vini2003.hammer.serialization.api.common.function.Function7;
import dev.vini2003.hammer.serialization.api.common.node.Node;
import org.jetbrains.annotations.Nullable;

public class CompoundNode7<R, T1, T2, T3, T4, T5, T6, T7, N1 extends Node<T1>, N2 extends Node<T2>, N3 extends Node<T3>, N4 extends Node<T4>, N5 extends Node<T5>, N6 extends Node<T6>, N7 extends Node<T7>> extends Node<R> {
	private final Function7<T1, T2, T3, T4, T5, T6, T7, R> mapper;
	...
	public CompoundNode7(N1 n1, N2 n2, N3 n3, N4 n4, N5 n5, N6 n6, N7 n7, Function7<T1, T2, T3, T4, T5, T6, T7, R> mapper) {
		this.n1 = n1;
		this.n2 = n2;
		this.n3 = n3;
		this.n4 = n4;
	...
	public <F, I> R deserialize(Deserializer<F> deserializer, @Nullable String key, F object, I instance) {
		...
		return set(mapper.apply(n1.deserialize(deserializer, key, map, instance), n2.deserialize(deserializer, key, map, instance), n3.deserialize(deserializer, key, map, instance), n4.deserialize(deserializer, key, map, instance), n5.deserialize(deserializer, key, map, instance), n6.deserialize(deserializer, key, map, instance), n7.deserialize(deserializer, key, map, instance)), instance);
	}
	...
	public String toString() {
		return "CompoundNode[" + (key == null ? "None" : key) + ", " + n1 + ", " + n2 + ", " + n3 + ", " + n4 + ", " + n5 + ", " + n6 + ", " + n7 + "]";
	}
}
