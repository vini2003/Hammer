...
import dev.vini2003.blade.client.utilities.Scissors
import net.minecraft.client.render.VertexConsumerProvider
import net.minecraft.client.util.math.MatrixStack
import net.minecraft.util.Identifier

open class HorizontalBarWidget(var maximum: () -> Float = {100F}, var current: () -> Float = {0F}, foregroundId: Identifier = BL.id("textures/widget/bar_foreground.png"), backgroundId: Identifier = BL.id("textures/widget/bar_background.png")) : AbstractWidget() {
	var foregroundTexture = PartitionedTexture(
		foregroundId,
		18F,
		18F,
	...
	var backgroundTexture = PartitionedTexture(
		backgroundId,
		18F,
		18F,
		0.05555555555555555556F,
