...
open class VerticalBarWidget(var maximum: () -> Float = {100F}, var current: () -> Float = {0F}, foregroundId: Identifier = BL.id("textures/widget/bar_foreground.png"), backgroundId: Identifier = BL.id("textures/widget/bar_background.png")) : AbstractWidget() {
